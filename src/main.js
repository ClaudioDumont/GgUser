...
const routes = [
  ...
  { path: '/names', name: 'names', component: FormStepsTwo },
  { path: '/email-confirmation', name: 'email', component: FormStepsThree },
  { path: '/error', name: 'error', component: OnError },
  { path: '/success', name: 'success', component: OnSuccess }
]
